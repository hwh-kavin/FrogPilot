...
class Controls(ControlsExt):
  ...
  def state_control(self):
    ...
    model_expected_steering_angle_deg = math.degrees(self.VM.get_steer_from_curvature(model_v2.action.desiredCurvature,
                                                                                       max(CS.vEgo, 0.1), lp.roll))
    model_expected_steering_angle_deg += lp.angleOffsetDeg
    ...
    htd_allowed, self.htd_state = self.htd.update(
      ...
      CS.steeringAngleDeg,
      CS.steeringPressed,
      model_expected_steering_angle_deg,
    )
